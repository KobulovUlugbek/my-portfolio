            ...
            <Dialog.Overlay className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
              <Dialog.Content className="relative bg-primary p-6 rounded-lg w-[500px] h-[500px] xl:w-[650px] xl:h-[650px] overflow-auto">
                ...
                <ScrollArea className="h-[400px]">
                  <div className="mt-2 text-sm text-white/80 overflow-auto max-h-[90%] scrollbar-accent">
                    <h1>Impressum</h1>
                    ...
                    <h2>Kontakt</h2>
                    <p>
                      Telefon: 015157338840
                      <br />
                      E-Mail: contact@ulugbek-kobulov.com
                    </p>
                ...
                <ScrollArea className="h-[400px] xl:h-[500px]">
                  <div className="mt-2 text-sm text-white/80 overflow-auto max-h-[90%] scrollbar-accent">
                    ...
                    <p>
                      ...
                      denen Sie pers&ouml;nlich identifiziert werden
                    ...
                    <p>
                      ...
                      Abschnitt &bdquo;Hinweis zur Verantwortlichen
                    ...
                    <h3>All-Inkl</h3>{" "}
                    <p>
                      Anbieter ist die ALL-INKL.COM - Neue Medien M&uuml;nnich,
                      Inh. Ren&eacute; M&uuml;nnich, Hauptstra&szlig;e 68, 02742
                      Friedersdorf (nachfolgend All-Inkl). Details entnehmen Sie
                    ...
                    <p>
                      ...
                      Interesse an einer m&ouml;glichst zuverl&auml;ssigen
                      Darstellung unserer Website. Sofern eine entsprechende
                      Einwilligung abgefragt wurde, erfolgt die Verarbeitung
                      ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit.
                      a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die
                    ...
                    <p>
                      ...
                      sind Daten, mit denen Sie pers&ouml;nlich identifiziert
                      werden k&ouml;nnen. Die vorliegende
                      Datenschutzerkl&auml;rung erl&auml;utert, welche Daten wir
                      erheben und wof&uuml;r wir sie nutzen. Sie erl&auml;utert
                    ...
                    <p>
                      ...
                      l&uuml;ckenloser Schutz der Daten vor dem Zugriff durch
                    ...
                    <p>
                      ...
                      personenbezogenen Daten bei uns, bis der Zweck f&uuml;r
                      die Datenverarbeitung entf&auml;llt. Wenn Sie ein
                      berechtigtes L&ouml;schersuchen geltend machen oder eine
                      Einwilligung zur Datenverarbeitung widerrufen, werden Ihre
                    ...
                    <p>
                      ...
                      Datenverarbeitung au&szlig;erdem auf Grundlage von Art. 49
                      Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von
                      Cookies oder in den Zugriff auf Informationen in Ihr
                      Endger&auml;t (z.&nbsp;B. via Device-Fingerprinting)
                      eingewilligt haben, erfolgt die Datenverarbeitung
                      zus&auml;tzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG.
                      Die Einwilligung ist jederzeit widerrufbar. Sind Ihre
                      Daten zur Vertragserf&uuml;llung oder zur
                      ...
                      den folgenden Abs&auml;tzen dieser
                      Datenschutzerkl&auml;rung informiert.
                    </p>
                    <h3>Empfänger von personenbezogenen Daten</h3>{" "}
                    <p>
                      Im Rahmen unserer Gesch&auml;ftst&auml;tigkeit arbeiten
                      wir mit verschiedenen externen Stellen zusammen. Dabei ist
                      teilweise auch eine &Uuml;bermittlung von
                      personenbezogenen Daten an diese externen Stellen
                      erforderlich. Wir geben personenbezogene Daten nur dann an
                      externe Stellen weiter, wenn dies im Rahmen einer
                      Vertragserf&uuml;llung erforderlich ist, wenn wir
                      gesetzlich hierzu verpflichtet sind (z.&nbsp;B. Weitergabe
                      von Daten an Steuerbeh&ouml;rden), wenn wir ein
                      ...
                      unserer Kunden nur auf Grundlage eines g&uuml;ltigen
                      Vertrags &uuml;ber Auftragsverarbeitung weiter. Im Falle
                      einer gemeinsamen Verarbeitung wird ein Vertrag &uuml;ber
                    ...
                    <p>
                      ...
                      RECHT, AUS GR&Uuml;NDEN, DIE SICH AUS IHRER BESONDEREN
                      ...
                      DATENSCHUTZERKL&Auml;RUNG. WENN SIE WIDERSPRUCH EINLEGEN,
                      ...
                      RECHTSANSPR&Uuml;CHEN (WIDERSPRUCH NACH ART. 21 ABS. 1
                      DSGVO).
                    </p>{" "}
                    <p>
                    ...
                    <p>
                      Im Falle von Verst&ouml;&szlig;en gegen die DSGVO steht
                      den Betroffenen ein Beschwerderecht bei einer
                      Aufsichtsbeh&ouml;rde, insbesondere in dem Mitgliedstaat
                      ihres gew&ouml;hnlichen Aufenthalts, ihres Arbeitsplatzes
                      oder des Orts des mutma&szlig;lichen Versto&szlig;es zu.
                    ...
                    <p>
                      ...
                      &Uuml;bertragung der Daten an einen anderen
                    ...
                    <p>
                      ...
                      Auskunft &uuml;ber Ihre gespeicherten personenbezogenen
                      ...
                      Fragen zum Thema personenbezogene Daten k&ouml;nnen Sie
